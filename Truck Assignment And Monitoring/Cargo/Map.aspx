<%@ Page Title="" Language="C#" MasterPageFile="~/Cargo/Cargo.Master" AutoEventWireup="true" CodeBehind="Map.aspx.cs" Inherits="Truck_Assignment_And_Monitoring.Cargo.Map" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cargoBody" runat="server">
    ...
    <script type="text/javascript">
           ...
           setInterval(function callIt() {
               ...
               var data = '../cargo.xml?t=' + timestamp;
                   ...
                   $(data).find("marker").each(
                       function () {
                           ...
                           popup = new Tmap.Popup("p1",
                               ...
                               "<div>Truck ID= " + truck + "</div>" + "<div>Number Plate= " + plate + "</div>" + "<div>Cargo ID= " + CargoID + "</div>"
                           );
