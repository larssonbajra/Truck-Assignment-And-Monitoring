<%@ Page Title="" Language="C#" MasterPageFile="~/Driver/Driver.Master" AutoEventWireup="true" CodeFile="NegotiateValues.aspx.cs" Inherits="Truck_Assignment_And_Monitoring.Driver.NegotiateValues" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function Negotiate() {
            ...
            alertify.alert("The Negotiation is done. Please wait for the owner's response", function (e) {
                if (e) {
